...
#include <tao/json/json5/to_string.hpp>
...
namespace tao
{
   namespace json
   {
      ...
      {
         TEST_ASSERT( json5::to_string( v ) == s );
      }

      void test_pretty( const value& v, const std::string& s )
      {
         TEST_ASSERT( json5::to_string( v, 2 ) == s );
      }
      ...
      void unit_test()
      {
         ...
         TEST_THROWS( json5::to_string( e ) );
#ifndef NDEBUG
         TEST_THROWS( json5::to_string( d ) );
#endif
