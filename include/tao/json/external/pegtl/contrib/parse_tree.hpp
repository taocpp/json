   ...
   namespace TAO_JSON_PEGTL_NAMESPACE
   {
      namespace parse_tree
      {
         ...
         struct selector< Rule, Collection, Collections... >
            : TAO_JSON_PEGTL_NAMESPACE::internal::conditional< Collection::template contains< Rule >::value >::template type< typename Collection::type, selector< Rule, Collections... > >
         {
         };
