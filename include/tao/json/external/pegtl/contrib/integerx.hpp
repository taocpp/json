...
#ifndef TAO_JSON_PEGTL_CONTRIB_INTEGERX_HPP
#define TAO_JSON_PEGTL_CONTRIB_INTEGERX_HPP
...
namespace TAO_JSON_PEGTL_NAMESPACE::integerx
{
   namespace internal
   {
   ...
   struct unsigned_rule
   {
      ...
      {
         return TAO_JSON_PEGTL_NAMESPACE::parse< internal::unsigned_rule_new >( in );  // Does not check for any overflow.
      }
   };
   ...
   struct unsigned_rule_with_action
   {
      ...
      [[nodiscard]] static auto match( Input& in, Unsigned& st ) -> std::enable_if_t< ( A == apply_mode::action ) && std::is_unsigned_v< Unsigned >, bool >
      {
         // This function "only" offers basic exception safety.
         st = 0;
         return TAO_JSON_PEGTL_NAMESPACE::parse< internal::unsigned_rule_new, internal::unsigned_action_action >( in, st );  // Throws on overflow.
      }
   ...
   struct maximum_rule
   {
      ...
      {
         Unsigned st = 0;
         return TAO_JSON_PEGTL_NAMESPACE::parse< internal::unsigned_rule_new, internal::maximum_action_helper< Unsigned, Maximum >::template type >( in, st );  // Throws on overflow.
      }
   };
   ...
   struct maximum_rule_with_action
   {
      ...
      {
         Unsigned st = 0;
         return TAO_JSON_PEGTL_NAMESPACE::parse< internal::unsigned_rule_new, internal::maximum_action_helper< Unsigned, Maximum >::type >( in );  // Throws on overflow.
      }
   ...
   struct signed_rule_with_action
   {
      ...
      [[nodiscard]] static auto match( Input& in, Signed& st ) -> std::enable_if_t< ( A == apply_mode::action ) && std::is_signed_v< Signed >, bool >
      {
         ...
         return TAO_JSON_PEGTL_NAMESPACE::parse< internal::signed_rule_new, internal::signed_action_action >( in, negative, st );  // Throws on overflow.
      }
