...
#ifndef TAO_JSON_PEGTL_CONTRIB_CHANGE_ACTION_AND_STATES_HPP
#define TAO_JSON_PEGTL_CONTRIB_CHANGE_ACTION_AND_STATES_HPP
...
namespace TAO_JSON_PEGTL_NAMESPACE
{
      ...
      : maybe_nothing
   {
      ...
      {
         auto t = std::tie( st... );
         if( TAO_JSON_PEGTL_NAMESPACE::match< Rule, A, M, NewAction, Control >( in, std::get< Ns >( t )... ) ) {
