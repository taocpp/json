...
#ifndef TAOCPP_JSON_PEGTL_INCLUDE_INTERNAL_ISTREAM_READER_HPP
#define TAOCPP_JSON_PEGTL_INCLUDE_INTERNAL_ISTREAM_READER_HPP
      ...
      namespace internal
      {
         struct istream_reader
         {
            ...
            std::size_t operator()( char* buffer, const std::size_t length )
            {
               ...
               TAOCPP_JSON_PEGTL_THROW_INPUT_ERROR( "error in istream.read()" );
            }
