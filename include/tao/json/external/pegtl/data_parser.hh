...
#ifndef TAOCPP_JSON_EMBEDDED_PEGTL_DATA_PARSER_HH
#define TAOCPP_JSON_EMBEDDED_PEGTL_DATA_PARSER_HH
...
namespace tao_json_pegtl
{
   ...
   public:
      ...
      data_parser( std::string data, std::string source, const tao_json_pegtl::input & from, const std::size_t line = 1, const std::size_t column = 0 )
            : m_data( std::move( data ) ),
              m_source( std::move( source ) ),
