   ...
   namespace json
   {
      namespace internal
      {
         ...
         struct unique_ptr_traits
         {
            ...
            static auto as( const basic_value< Traits, Base >& v, With&... with ) -> typename std::enable_if< use_first_ptr_as< T, Traits, Base, With... >::value, std::unique_ptr< U > >::type
            {
               return std::unique_ptr< U >( new T( v, with... ) );
            }

            template< template< typename... > class Traits, typename Base, typename... With >
            static auto as( const basic_value< Traits, Base >& v, With&... with ) -> typename std::enable_if< use_second_ptr_as< T, Traits, Base, With... >::value || use_fourth_ptr_as< T, Traits, Base, With... >::value, std::unique_ptr< U > >::type
            {
               return std::unique_ptr< U >( new T( Traits< T >::as( v, with... ) ) );
            }

            template< template< typename... > class Traits, typename Base, typename... With >
            static auto as( const basic_value< Traits, Base >& v, With&... with ) -> typename std::enable_if< use_third_ptr_as< T, Traits, Base, With... >::value, std::unique_ptr< U > >::type
            {
