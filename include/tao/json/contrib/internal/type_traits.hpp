...
namespace tao
{
   namespace json
   {
      namespace internal
      {
         ...
         template< typename T, template< typename... > class Traits, typename... With >
         inline constexpr bool use_second_ptr_as = !use_first_ptr_as< T, Traits, With... > && std::is_move_constructible_v< T > && has_as< Traits< T >, basic_value< Traits >, With... >::value;

         template< typename T, template< typename... > class Traits, typename... With >
         inline constexpr bool use_third_ptr_as = !use_first_ptr_as< T, Traits, With... > && !use_second_ptr_as< T, Traits, With... > && std::is_default_constructible_v< T > && has_to< Traits< T >, basic_value< Traits >, T, With... >::value;

         template< typename T, template< typename... > class Traits, typename... With >
         inline constexpr bool use_fourth_ptr_as = !use_first_ptr_as< T, Traits, With... > && !use_third_ptr_as< T, Traits, With... > && std::is_copy_constructible_v< T > && has_as< Traits< T >, basic_value< Traits >, With... >::value;
