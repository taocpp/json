...
namespace tao
{
   namespace json
   {
      namespace events
      {
         ...
         {
            events::from_string( data, size, consumer, source.c_str(), byte, line, column );
         }
         ...
         {
            events::from_string( data.data(), data.size(), consumer, source, byte, line, column );
         }
         ...
         {
            events::from_string( data, consumer, source.c_str(), byte, line, column );
         }
