...
#ifndef TAOCPP_JSON_INCLUDE_JSON5_FROM_STREAM_HPP
#define TAOCPP_JSON_INCLUDE_JSON5_FROM_STREAM_HPP

#include <cstddef>
#include <string>
#include <utility>

#include "../events/json5/from_stream.hpp"
   ...
   namespace json
   {
      namespace json5
      {
         ...
         basic_value< Traits > from_stream( std::istream& stream, const char* source = nullptr, const std::size_t maximum_buffer_size = 4000 )
         {
            ...
            events::json5::from_stream( stream, consumer, source, maximum_buffer_size );
