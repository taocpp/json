...
#ifndef TAOCPP_JSON_INCLUDE_JSON5_PARSE_FILE_HPP
#define TAOCPP_JSON_INCLUDE_JSON5_PARSE_FILE_HPP

#include <string>
#include <utility>

#include "../events/json5/parse_file.hpp"
   ...
   namespace json
   {
      namespace json5
      {
         ...
         basic_value< Traits > parse_file( const std::string& filename )
         {
            ...
            events::json5::parse_file( filename, consumer );
