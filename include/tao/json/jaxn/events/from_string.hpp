...
namespace tao::json::jaxn::events
{
   ...
   {
      pegtl::memory_input< pegtl::tracking_mode::lazy, pegtl::eol::lf_crlf, const char* > in( data, data + size, source ? source : "tao::json::jaxn::events::from_string", byte, line, byte_in_line );
   ...
   {
      jaxn::events::from_string( consumer, data, size, source.c_str(), byte, line, byte_in_line );
   }
