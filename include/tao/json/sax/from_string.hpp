...
namespace tao
{
   namespace json
   {
      namespace sax
      {
         ...
         {
            json_pegtl::memory_input< json_pegtl::tracking_mode::LAZY, json_pegtl::lf_crlf_eol, const char* > input( data, data + size, source ? source : "tao::json::sax::from_string", byte, line, column );
